...
namespace :app do
  ...
  desc "Reset"      # this custom task rebuilds the dev. database and populates
  task :reset => [:ensure_development_environment, "db:drop", "db:create", 
    "db:migrate", "db:seed", "app:populate"]
